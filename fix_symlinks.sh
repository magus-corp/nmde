...
for config_path in /home/cmgus/.local/share/nmde/config/*; do
  config_name=$(basename "$config_path")
  target_path="/home/cmgus/.config/$config_name"
...
rm -f /home/cmgus/.bashrc
ln -s /home/cmgus/.local/share/nmde/default/bashrc /home/cmgus/.bashrc
